...
double find_optimum_quadratic(const MultipartiteGraph& G, bool relaxed, bool path_constraints, bool print_variable_values){
...
//                    model.addConstr(varsAsNeighbors_scaled[{i-1,k}]>=vars_scaled[{i,j}]);
                }
            }
        }
