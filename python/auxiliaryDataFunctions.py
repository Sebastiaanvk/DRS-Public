...
colorMap = {
    ...
    "dynSinglePathsUni.txt" : "blue", 
    "dynSinglePathsBi.txt" : "blue", 
    "baselineEverythingUni.txt" : "orange",
    "baselineEverythingBi.txt" : "orange",
}
...
markerMap = {
    ...
    "dynSinglePathsUni.txt" : "o", 
    "dynSinglePathsBi.txt" : "o", 
    "baselineEverythingUni.txt" : "^",
    "baselineEverythingBi.txt" : "^",
}
